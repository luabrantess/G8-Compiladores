...
- **Tipos de Dados**: `int`, `char`, `double` e `float` (com suporte a declaração de vetores/arrays na sintaxe padrão do C e literais de texto).
...
| 5.0    | 24/06/2026 | Túlio Celeri     | Correção das especificações do compilador | |
